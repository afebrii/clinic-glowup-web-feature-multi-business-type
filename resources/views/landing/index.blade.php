...
$lt = new \Illuminate\Support\Fluent($landingThemes[$businessType] ?? $landingThemes['clinic']);
@endphp
                ...
                <div class="mt-6 animate-fade-in-up stagger-5">
                    ...
                    <div class="flex flex-wrap gap-3">
                        <span class="inline-flex items-center px-3 py-1.5 bg-white rounded-full text-sm text-gray-600 border border-gray-200">
                            <svg class="w-4 h-4 mr-1.5 {{ $lt->text }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
